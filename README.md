...
本番Rules公開後、匿名Auth未対応または旧書き込み形式のキャッシュはFirestoreへ接続できません。v156小修正版では`game.js?v=156a`と`style.css?v=156a`を使用します。新しいHTML・JavaScript・CSSの配信を確認してからRulesを公開してください。
