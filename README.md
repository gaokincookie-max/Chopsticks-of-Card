...
本番Rules公開後、匿名Auth未対応または旧書き込み形式のキャッシュはFirestoreへ接続できません。v155修正版では`game.js?v=155i`と`style.css?v=155d`を使用します。新しいHTML・JavaScript・CSSの配信を確認してからRulesを公開してください。
