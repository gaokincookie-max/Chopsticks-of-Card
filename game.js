const CARD_LIBRARY = {
      ...
      setupTrap: {
        ...
        effect: (player) => {
          ...
          state.temp[player].setupFromCopiedEffect = !!state.copiedEffectContext?.ignoreTerminal;
